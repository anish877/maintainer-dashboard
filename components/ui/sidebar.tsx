    ...
    <div className={`min-w-fit ${sidebarExpanded ? 'sidebar-expanded' : ''}`}>
      ...
      >      
        ...
        <div className="space-y-8">
            ...
            <ul className="mt-3">
              ...
              <li className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r ${segments.includes('contributor-analytics') && 'from-emerald-500/[0.12] dark:from-emerald-500/[0.24] to-emerald-500/[0.04]'}`}>
                <SidebarLink href="/contributor-analytics">
                  <div className="flex items-center">
                    <svg className={`shrink-0 fill-current ${segments.includes('contributor-analytics') ? 'text-emerald-500' : 'text-gray-400 dark:text-gray-500'}`} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                      <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0zm0 14A6 6 0 1 1 8 2a6 6 0 0 1 0 12zm-1-9h2v2H7V5zm0 3h2v4H7V8z"/>
                    </svg>
                    <span className="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
          ...
          {/* AI-Powered Tools - Show when in repository context */}
          {segments.length > 0 && segments[0] !== 'dashboard' && segments[0] !== 'chat' && segments[0] !== 'repos' && segments[0] !== 'assignments' && segments[0] !== 'scraper-dashboard' && segments[0] !== 'completeness' && segments[0] !== 'contributor-analytics' && (
            <div>
              <h3 className="text-xs uppercase text-gray-400 dark:text-gray-500 font-semibold pl-3">
                <span className="hidden lg:block lg:sidebar-expanded:hidden 2xl:hidden text-center w-6" aria-hidden="true">
                  •••
                </span>
                <span className="lg:hidden lg:sidebar-expanded:block 2xl:block">AI-Powered Tools</span>
              </h3>
              <ul className="mt-3">
                {/* AI Scraper */}
                <li className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r ${segments.includes('scraper') && 'from-purple-500/[0.12] dark:from-purple-500/[0.24] to-purple-500/[0.04]'}`}>
                  <SidebarLink href={`/${segments[0]}/scraper`}>
                    <div className="flex items-center">
                      <svg className={`shrink-0 fill-current ${segments.includes('scraper') ? 'text-purple-500' : 'text-gray-400 dark:text-gray-500'}`} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0ZM1.5 8a6.5 6.5 0 1 1 13 0 6.5 6.5 0 0 1-13 0Z"/>
                        <path d="M8 3.5a.5.5 0 0 0-1 0v3a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 0-1H8V3.5Z"/>
                        <path d="M12 8a4 4 0 1 1-8 0 4 4 0 0 1 8 0Z"/>
                      </svg>
                ...
                <li className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r ${segments.includes('completeness') && 'from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]'}`}>
                  <SidebarLink href={`/${segments[0]}/completeness`}>
                    <div className="flex items-center">
                      <svg className={`shrink-0 fill-current ${segments.includes('completeness') ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'}`} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                      </svg>
                ...
                {/* Health Analytics */}
                <li className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r ${segments.includes('health') && 'from-emerald-500/[0.12] dark:from-emerald-500/[0.24] to-emerald-500/[0.04]'}`}>
                  <SidebarLink href={`/${segments[0]}/health`}>
                    <div className="flex items-center">
                      <svg className={`shrink-0 fill-current ${segments.includes('health') ? 'text-emerald-500' : 'text-gray-400 dark:text-gray-500'}`} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0zm0 14A6 6 0 1 1 8 2a6 6 0 0 1 0 12zm-1-9h2v2H7V5zm0 3h2v4H7V8z"/>
                      </svg>
                      <span className="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                        Health Analytics
